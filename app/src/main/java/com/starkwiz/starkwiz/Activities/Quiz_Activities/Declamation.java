...
public class Declamation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv_tpopics.setLayoutManager(new LinearLayoutManager(Declamation.this));
        list_topics = new ArrayList<>();
        Calendar cal=Calendar.getInstance();
        SimpleDateFormat month_date = new SimpleDateFormat("MMMM");
        String month = month_date.format(cal.getTime());
        Userid = SharedPrefManager.getInstance(Declamation.this).getUser().getId();
        ...
        btn_music_upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Dialog dialog = new Dialog(Declamation.this); ;
                ...
                GetTopics();
                Topic_SpinnerAdapter adapter = new Topic_SpinnerAdapter(Declamation.this, android.R.layout.simple_spinner_dropdown_item, list_topics);
                ...
                txt_music_done.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Toast.makeText(Declamation.this, "Uploading Please wait..", Toast.LENGTH_SHORT).show();
...
// totalSize = entity.getContentLength();
                            ...
                            if (statusCode == 201) {
                                ...
                                responseString = "Error occurred! Http Status Code: "
                                        + statusCode;
                                Toast.makeText(Declamation.this, responseString, Toast.LENGTH_SHORT).show();
                            }
    ...
    private void GetTopics(){
        ...
        String cls = SharedPrefManager.getInstance(Declamation.this).getUser().getCls();

        ProgressDialog dialog = new ProgressDialog(Declamation.this);
        dialog.setMessage("Loading...");
        dialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                "https://rentopool.com/starkwiz/api/auth/gettopicbycategory?category=Declamation&class="+cls,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0 ; i<array.length(); i++){
                                ...
                                Topic_Adapter adapter = new Topic_Adapter(list_topics,Declamation.this);
        ...
        MySingleton.getInstance(Declamation.this).addToRequestque(stringRequest);
    }
