...
public class Debate_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_debate_);
        ...
        lv_tpopics.setLayoutManager(new LinearLayoutManager(Debate_Activity.this));
        list_topics = new ArrayList<>();
        Calendar cal=Calendar.getInstance();
        SimpleDateFormat month_date = new SimpleDateFormat("MMMM");
        String month = month_date.format(cal.getTime());
        Userid = SharedPrefManager.getInstance(Debate_Activity.this).getUser().getId();
        ...
        btn_music_upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Dialog dialog = new Dialog(Debate_Activity.this); ;
                ...
                GetTopics();
                Topic_SpinnerAdapter adapter = new Topic_SpinnerAdapter(Debate_Activity.this, android.R.layout.simple_spinner_dropdown_item, list_topics);
                ...
                txt_music_done.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Toast.makeText(Debate_Activity.this, "Uploading Please wait..", Toast.LENGTH_SHORT).show();
...
// totalSize = entity.getContentLength();
                            ...
                            if (statusCode == 201) {
                                ...
                                responseString = "Error occurred! Http Status Code: "
                                        + statusCode;
                                Toast.makeText(Debate_Activity.this, responseString, Toast.LENGTH_SHORT).show();
                            }
    ...
    private void GetTopics(){
        String cls = SharedPrefManager.getInstance(Debate_Activity.this).getUser().getCls();
        ProgressDialog dialog = new ProgressDialog(Debate_Activity.this);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0 ; i<array.length(); i++){
                                ...
                                Topic_Adapter adapter = new Topic_Adapter(list_topics,Debate_Activity.this);
        ...
        MySingleton.getInstance(Debate_Activity.this).addToRequestque(stringRequest);
    }
    ...
    public void CreateNotification(String user_id, String notification_text){
        ...
        ProgressDialog progressDialog = new ProgressDialog(Debate_Activity.this);
        ...
        JsonObjectRequest jsonRequest = new JsonObjectRequest(Request.Method.POST, URLS.createnotification, parameters, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Debate_Activity.this, "Something went wrong ", Toast.LENGTH_SHORT).show();
            }
        });


        Volley.newRequestQueue(Debate_Activity.this).add(jsonRequest);
    }
