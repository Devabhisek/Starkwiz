...
public class ScheduleList_Adapter extends RecyclerView.Adapter<ScheduleList_Adapter.ViewHolder> {
    ...
    public ScheduleList_Adapter(ArrayList<GetTestList_ModelClass> listitems, Activity context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ScheduleList_Adapter.ViewHolder(latest_v);
    }
