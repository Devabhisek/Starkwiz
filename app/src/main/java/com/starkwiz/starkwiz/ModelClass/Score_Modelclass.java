...
public class Score_Modelclass {
    ...
    String id,user_id,test_id,module_id,subject_name,total_question,total_marks,total_marks_obtained,total_points_obtained,
            total_time,total_acquired_time,total_correct_answer,subjectName,module_name,name,lastname,cls,district,state;

    public Score_Modelclass(String id, String user_id, String test_id, String module_id, String subject_name, String total_question, String total_marks, String total_marks_obtained,
                            String total_points_obtained, String total_time, String total_acquired_time, String total_correct_answer, String subjectName, String module_name, String name, String lastname, String cls, String district, String state) {
        this.id = id;
